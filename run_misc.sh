...
max_pathlens=(5 6 8)
thresholds=(0.6075)
false_negatives=(0.1 0.25 0.5 0.75 1)
...
jbsub -q x86_24h -mem 40g -require k80 -cores 1x1+1 -out "Results/Output_train_test_same.txt" python Attention_train_test_same.py 6 5 Input/data_demarcated.pkl